...
(function() {
  ...
  Cartograph = (function() {
    var extractParamNames, name_regexp, named_param_regexp, named_param_replace, parseQueryParams, routeToRegExp, splat_regexp, splat_replace;
    ...
    routeToRegExp = function(route) {
      route = route.replace(named_param_regexp, named_param_replace).replace(splat_regexp, splat_replace);
      return new RegExp("^" + route + "$", "gi");
    };

    extractParamNames = function(route) {
      var name, names, _results;
      _results = [];
    ...
    Cartograph.prototype.scan = function(msg, route) {
      var data, i, match, name, names, params, re, _i, _len;
