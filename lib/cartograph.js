...
(function() {
  ...
  Cartograph = (function() {
    var extractParamNames, parseQueryParams, routeToRegExp;

    routeToRegExp = function(route) {
      var named_param_regexp, named_param_replace, splat_regexp, splat_replace;
    ...
    Cartograph.prototype.scan = function(msg, route, mapping) {
      ...
      if ((mapping != null) && (mapping.regexp != null)) {
        re = mapping.regexp;
      } else {
