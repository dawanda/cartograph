...
(function() {
  ...
  Cartograph = (function() {
    var decode, extractParamNames, param_regexp, param_replace, parseQueryParams, peek, routeToRegExp, splat_regexp, splat_replace;
    ...
    parseQueryParams = function(querystr) {
      var k, match, name, params, re, _i, _ref;
      params = {};
      if (querystr != null) {
        re = /[\?&]([^=&]+)=?([^&$]+)?/g;
    ...
    decode = function(v) {
      ...
      return decodeURIComponent(v.replace("+", "%20"));
    };
