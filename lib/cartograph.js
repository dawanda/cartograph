...
(function() {
  ...
  Cartograph = (function() {
    var decode, extractParamNames, nestedObject, param_regexp, param_replace, parseQueryParams, peek, routeToRegExp, splat_regexp, splat_replace;
    ...
    nestedObject = function(obj, nesting, value, overwrite) {
      var last_part, part, parts, re, root, root_re, _i, _len, _ref, _ref1;
      root_re = /^([^\[]+)(\[|$)/;
      re = /\[([^\]]+)\]/g;
      root = (_ref = root_re.exec(nesting)) != null ? _ref[1] : void 0;
      parts = [root];
    ...
    Cartograph.prototype.map = function(route, fn) {
      ...
      prefixed_route = (peek(this._prefix_stack) || "") + route;
    ...
    Cartograph.prototype.namespace = function(ns, fn) {
      ...
      this._prefix_stack.push((peek(this._prefix_stack) || "") + ns);
      fn.call(this);
